...
return [
    ...
    'webdav' => [
        'up' => 'Ένα φάκελο επάνω',
        'import' => 'Εισαγωγή :count επιλεγμένων',
        'loading' => 'Φόρτωση φακέλου...',
        'empty' => 'Αυτός ο φάκελος είναι κενός.',
        'unreachable' => 'Δεν ήταν δυνατή η σύνδεση με τον κοινόχρηστο φάκελο.',
        'import_failed' => 'Δεν ήταν δυνατή η εισαγωγή αυτών των αρχείων.',
        'import_partial' => '{1} Δεν ήταν δυνατή η εισαγωγή του :names.|[2,*] Δεν ήταν δυνατή η εισαγωγή :count αρχείων: :names',
    ],
];
