...
return [
    ...
    'webdav' => [
        'up' => 'На папку выше',
        'import' => 'Импортировать выбранное (:count)',
        'loading' => 'Загрузка папки...',
        'empty' => 'Эта папка пуста.',
        'unreachable' => 'Не удалось подключиться к общему ресурсу.',
        'import_failed' => 'Не удалось импортировать эти файлы.',
        'import_partial' => '{1} Не удалось импортировать :names.|[2,*] Не удалось импортировать файлов: :count — :names',
    ],
];
